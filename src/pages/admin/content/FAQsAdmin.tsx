...
export const FAQsAdmin: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
          ...
          {faqs.map((f, idx) => (
            <div key={f.id} className={`bg-white rounded-2xl border border-slate-200 p-4 flex items-start gap-3 hover:border-blue-100 transition-all ${!f.active ? 'opacity-50' : ''}`}>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button onClick={() => setDeleteId(f.id)} className="p-1.5 rounded-lg hover:bg-rose-50 text-slate-400 hover:text-rose-600 cursor-pointer">
      ...
      <Modal isOpen={!!deleteId} onClose={() => setDeleteId(null)} title="Delete FAQ" maxWidth="sm"
        footer={
          <>
      ...
      >
        <p className="text-sm text-slate-700">Are you sure you want to delete this FAQ? This cannot be undone.</p>
      </Modal>
