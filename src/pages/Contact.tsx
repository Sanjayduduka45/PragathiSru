          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-2xs hover:shadow-xl hover:border-blue-300 hover:-translate-y-1 hover:scale-[1.01] active:translate-y-0 motion-reduce:hover:translate-y-0 motion-reduce:hover:scale-100 transition-all duration-300 ease-out space-y-4 flex flex-col justify-between group cursor-default">
            ...
            <div className="pt-4 border-t border-slate-100">
              <a
                ...
                className="inline-flex items-center gap-2 text-sm sm:text-base font-extrabold text-[#004182] hover:text-blue-900 transition-colors break-all focus-visible:outline-2 focus-visible:outline-[#004182]"
              >
                <span>{eventSettings.contactEmail}</span>
                <ArrowRight className="w-4 h-4 shrink-0 group-hover:translate-x-1 transition-transform duration-200 text-[#004182]" />
              </a>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-2xs hover:shadow-xl hover:border-blue-300 hover:-translate-y-1 hover:scale-[1.01] active:translate-y-0 motion-reduce:hover:translate-y-0 motion-reduce:hover:scale-100 transition-all duration-300 ease-out space-y-4 flex flex-col justify-between group cursor-default">
            ...
            <div className="pt-4 border-t border-slate-100">
              <a
                ...
                className="inline-flex items-center gap-2 text-sm sm:text-base font-extrabold text-[#004182] hover:text-blue-900 transition-colors focus-visible:outline-2 focus-visible:outline-[#004182]"
              >
