...
@router.get("/api/event-details", response_model=EventResponse)
@router.get("/api/admin/event-details", response_model=EventResponse)
async def get_event():
...
@router.put("/api/admin/event-details", response_model=EventResponse)
